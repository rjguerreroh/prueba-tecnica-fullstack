export const getCustomFormById = async () => {
  const url = "http://localhost:3000/custom_form/6529a7bafac07c70960ac0ee";
  ...
  try {
    ...
    return [{
      data: data.form_custom_data,
      id: data._id,
      fields: data.form_custom_fields,
      name: data.form_custom_name,
    }]
  } catch (error) {
    console.error(error);
